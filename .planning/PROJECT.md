...
<!-- REFACTOR-10 validated in Phase 09 (REFW-01) — moved to Validated -->
<!-- REFACTOR-13 validated in Phase 09 (REFW-02) — moved to Validated -->
<!-- REFACTOR-14 validated in Phase 09 (REFW-03) — moved to Validated -->

**清理与质量**

<!-- REFACTOR-11 validated in Phase 10 (REFC-01) — moved to Validated -->
<!-- REFACTOR-12 validated in Phase 10 (REFC-02) — moved to Validated -->
<!-- REFACTOR-13 web 部分（SessionList / message-window-store / settings / HappyComposer）validated in Phase 09; reducerTimeline 留待后续 phase 处理 -->
<!-- REFACTOR-14 web 部分 validated in Phase 09; Cursor permission mode 映射等 cli/hub 工具函数留待后续 phase 处理 -->
<!-- REFACTOR-15 validated in Phase 11 (REFT-01, REFT-02, REFT-03) — moved to Validated -->
...
---
*Last updated: 2026-05-23 after Phase 11 (test gap fill)*
