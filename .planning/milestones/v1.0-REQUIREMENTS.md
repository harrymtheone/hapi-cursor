# Milestone v1.0 Requirements Archive: Refactor & Slim-Down

**Status:** ✅ SHIPPED 2026-05-23
**Coverage:** 33 / 33 v1 requirements complete (100%)
**Sign-off:** `.planning/milestones/v1.0-phases/12-docs-cleanup-milestone-verification/12-VERIFICATION.md`
...
- [x] **REFA-01**: flavor capability 抽象完整化（`shared/src/flavors.ts`）。Cursor capability set 可扩展，所有「能力是否可用」的判定都从这张表读，不在调用点写硬编码 if-else
...
|-------------|-------|--------|
| CUT-01 | Phase 1 (Cut non-Cursor agents) | Complete |
| CUT-02 | Phase 1 (Cut non-Cursor agents) | Complete |
| CUT-03 | Phase 1 (Cut non-Cursor agents) | Complete |
| CUT-04 | Phase 1 (Cut non-Cursor agents) | Complete |
...
| CUT-05 | Phase 5 (Flavor consolidation + capability abstraction) | Complete |
| REFA-01 | Phase 5 (Flavor consolidation + capability abstraction) | Complete |
