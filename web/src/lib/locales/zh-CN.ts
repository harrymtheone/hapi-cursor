export default {
  ...
  'composer.modelPicker.thinking.off': '关',
  'composer.modelPicker.thinking.on': '开',
  'composer.modelPicker.option.fast': '快速',
  'composer.modelPicker.fast.off': '关',
  'composer.modelPicker.fast.on': '开',
  'composer.modelPicker.option.context': '上下文',
