export default {
  ...
  'settings.skills.catalog.callout': '技能由本机 Cursor 发现。打开带项目的会话可扫描项目技能。',
  ...
  'settings.skills.catalog.footerNote': '此目录为只读。',
  'settings.skills.catalog.source.global': '全局',
  'settings.skills.catalog.source.local': '本地',
