export default {
  ...
  'newSession.model.autoUnspecified': '自动（未指定）',
  'newSession.model.discovery.loading': '正在加载 Cursor 模型...',
  'newSession.model.discovery.error': '无法加载 Cursor 模型。可以重试发现，或继续使用自动模式。',
  'newSession.model.discovery.retry': '重试发现',
  'newSession.model.discovery.emptyTitle': '未找到 Cursor 模型',
  'newSession.model.discovery.emptyBody': '可以继续使用自动模式，或检查本机 Cursor CLI 后重试发现。',
  'newSession.model.discovery.reason.cursorCliUnavailable': 'Cursor CLI 不可用',
  'newSession.model.discovery.reason.notAuthenticated': '未认证',
  'newSession.model.discovery.reason.timedOut': '已超时',
  'newSession.model.discovery.reason.emptyModelList': '未返回模型',
  'newSession.model.discovery.reason.unknown': '未知发现错误',
  'newSession.model.launchRejected': 'Cursor 拒绝了所选运行时配置。请选择其他模型，或继续使用自动模式。',
  ...
  'composer.model.availableWhenIdle': '会话空闲时可切换',
  'composer.modelPicker.auto': '自动',
  'composer.modelPicker.edit': '编辑',
  'composer.modelPicker.select': '选择',
  'composer.modelPicker.apply': '应用',
  'composer.modelPicker.back': '返回',
  'composer.modelPicker.manageVisible': '管理可见模型…',
  'composer.modelPicker.option.thinking': '思考',
  'composer.modelPicker.option.fast': '快速',
  'composer.modelPicker.option.context': '1M 上下文',
  'composer.modelPicker.option.effort': '强度',
  'composer.modelPicker.effort.low': '低',
  'composer.modelPicker.effort.medium': '中',
  'composer.modelPicker.effort.high': '高',
  'composer.modelPicker.effort.xhigh': '极高',
  'composer.modelPicker.effort.max': '最大',
  ...
  'settings.models.title': '可见模型',
  'settings.models.sectionTitle': '模型',
  'settings.models.rowTitle': '可见模型',
  'settings.models.searchPlaceholder': '搜索模型系列',
  'settings.models.save': '保存',
  'settings.models.summary.all': '全部模型',
  'settings.models.summary.count': '已选 {{count}} 项',
  'settings.models.summary.none': '无',
  'settings.skills.title': '技能',
  'settings.skills.sectionTitle': '技能',
  'settings.skills.rowTitle': '技能目录',
  'settings.skills.summary.count': '{{count}} 个技能',
  'settings.skills.summary.none': '无技能',
  'settings.skills.summary.error': '无法加载',
  'settings.skills.summary.loading': '加载中…',
  'settings.skills.catalog.callout': '强制执行标签在活跃会话策略中生效。HAPI 会话策略控制每个聊天中启用哪些技能。',
  'settings.skills.catalog.sessionNote': '显示所选会话工作区中的技能。',
  'settings.skills.catalog.loading': '正在加载技能…',
  'settings.skills.catalog.emptyTitle': '未发现技能',
  'settings.skills.catalog.emptyBody': '技能从本机 Cursor 技能文件夹加载。打开项目的会话可扫描项目技能。',
  'settings.skills.catalog.error': '无法加载技能',
  'settings.skills.catalog.errorBody': '请确认会话已连接后重试。您仍可聊天；技能建议可能不可用。',
  'settings.skills.catalog.retry': '重试',
  'settings.skills.catalog.footerNote': '策略在聊天中按会话设置。此列表为只读。',
  'settings.skills.catalog.source.project': '项目',
  'settings.skills.catalog.source.user': '用户',
  'settings.skills.catalog.source.unknown': '未知',
  'settings.skills.catalog.invocationMode': '模式：{{mode}}',
  'session.skills.title': '技能',
  'session.skills.invalidTag': '无效',
  'session.skills.scope.global': '全局',
  'session.skills.scope.local': '本地',
  'session.skills.sheetTitle': '会话技能',
  'session.skills.done': '完成',
  'session.skills.inheritedHelper': '继承的技能遵循 Cursor 发现规则。HAPI 可仅为本会话启用或禁用技能。',
  'session.skills.searchPlaceholder': '搜索技能',
  'session.skills.loading': '正在加载技能…',
  'session.skills.error': '无法加载技能',
  'session.skills.errorBody': '请确认会话已连接后重试。您仍可聊天；技能建议可能不可用。',
  'session.skills.retry': '重试',
  'session.skills.emptyTitle': '未发现技能',
  'session.skills.emptyBody': '技能从本机 Cursor 技能文件夹加载。打开项目的会话可扫描项目技能。',
  'session.skills.browseCatalog': '浏览技能目录',
  'session.skills.resetAll': '全部重置为继承',
  'session.skills.triState.inherited': '继承',
  'session.skills.triState.enabled': '启用',
  'session.skills.triState.disabled': '禁用',
  'session.skills.enforcement.hapi': 'HAPI 会话策略',
  'session.skills.enforcement.cursor': 'Cursor 强制执行',
  'session.skills.invalidPolicyHint': '元数据有效前不可用',
  'session.skills.source.project': '项目',
  'session.skills.source.user': '用户',
  'session.skills.source.unknown': '未知',
  'session.skills.invocationMode': '模式：{{mode}}',
  'composer.skillsPolicy': '会话技能策略',
