export default {
  ...
  'settings.skills.catalog.callout': 'Skills are discovered by Cursor on this machine. Open a session with a project to scan project skills.',
  ...
  'settings.skills.catalog.footerNote': 'This catalog is read-only.',
  'settings.skills.catalog.source.global': 'Global',
  'settings.skills.catalog.source.local': 'Local',
