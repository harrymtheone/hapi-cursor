export default {
  ...
  'composer.modelPicker.thinking.off': 'Off',
  'composer.modelPicker.thinking.on': 'On',
  'composer.modelPicker.option.fast': 'Fast',
  'composer.modelPicker.fast.off': 'Off',
  'composer.modelPicker.fast.on': 'On',
  'composer.modelPicker.option.context': 'Context',
  'composer.modelPicker.context.standard': '272K',
  'composer.modelPicker.context.1m': '1M',
