...
export function createApp(
    ...
    const baseEngine: Partial<SyncEngine> = {
        ...
        applySkillPolicy: (async () => { }) as unknown as SyncEngine['applySkillPolicy'],
        applySkillPolicyBatch: (async () => { }) as unknown as SyncEngine['applySkillPolicyBatch'],
        resetSessionSkillPolicy: (async () => { }) as unknown as SyncEngine['resetSessionSkillPolicy'],
